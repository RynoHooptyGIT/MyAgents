...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config @team/workflows/problem-solving/workflow.yaml
3. Pass the yaml path team/workflows/problem-solving/workflow.yaml as 'workflow-config' parameter to the workflow.xml instructions
