...
2. READ its entire contents - this is the CORE OS for EXECUTING the specific workflow-config @team/workflows/design-thinking/workflow.yaml
3. Pass the yaml path team/workflows/design-thinking/workflow.yaml as 'workflow-config' parameter to the workflow.xml instructions
