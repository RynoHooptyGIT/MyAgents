...
2. Create session directory:
   output/.orchestrator/session-{timestamp}/
...
# Located: output/.orchestrator/session-{timestamp}/manifest.yaml
```
...
orchestrator_context:
  ...
  session_directory: "output/.orchestrator/session-{timestamp}"
