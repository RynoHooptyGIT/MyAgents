...
- The `{project-root}/team/engine/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/team/engine/validate-workflow.xml`
