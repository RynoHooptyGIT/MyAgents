...
workflow_path: '{project-root}/team/workflows/quick-flow/quick-spec'
...
- **[r]**: Execute Adversarial Review:
    1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using {project-root}/team/engine/review-adversarial-general.xml</invoke-task>
