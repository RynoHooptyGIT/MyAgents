...
workflow_path: '{project-root}/team/workflows/quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using {project-root}/team/engine/review-adversarial-general.xml</invoke-task>
```
