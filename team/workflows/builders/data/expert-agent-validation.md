...
- [ ] **Loads sidecar memories:** `{project-root}/team/_memory/{sidecar-folder}/memories.md`
- [ ] **Loads sidecar instructions:** `{project-root}/team/_memory/{sidecar-folder}/instructions.md`
- [ ] **Restricts file access:** `ONLY read/write files in {project-root}/team/_memory/{sidecar-folder}/`
...
- [ ] ALL sidecar paths use: `{project-root}/team/_memory/{sidecar-folder}/...`
...
- [ ] References from agent YAML to sidecar use `{project-root}/team/_memory/` format
...
**Fix:** `{project-root}/team/_memory/journal-keeper-sidecar/memories.md`
