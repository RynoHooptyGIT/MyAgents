...
- trigger: CP or fuzzy match on create-prd
  exec: '{project-root}/team/workflows/create-prd/workflow.md'
  description: '[CP] Create Product Requirements Document'

- trigger: GB or fuzzy match on brainstorm
  exec: '{project-root}/team/workflows/brainstorming/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '{project-root}/team/tasks/team-standup.md'
  data: '{project-root}/team/agent-manifest.csv'
...
critical_actions:
  ...
  - 'Load COMPLETE file {project-root}/team/_memory/journal-keeper-sidecar/instructions.md'
...
menu:
  ...
  - trigger: QC or fuzzy match on quick-capture
    action: 'Save entry to {project-root}/team/_memory/journal-keeper-sidecar/entries/entry-{date}.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{project-root}/team/workflows/workflow-status/workflow.md'
...
6. **Expert sidecars:** `{project-root}/team/_memory/{sidecar-folder}/`
