...
critical-actions:
  - name: '{action-name}'
    ...
    sidecar-files:
      - '{project-root}/team/_memory/{sidecar-folder}/{file1}.md'
      - '{project-root}/team/_memory/{sidecar-folder}/{file2}.md'
...
metadata:
  sidecar-folder: '{sidecar-folder-name}'
  sidecar-path: '{project-root}/team/_memory/{sidecar-folder}/'
  agent-type: 'expert'
...
✅ critical_actions reference `{project-root}/team/_memory/{sidecar-folder}/` paths
