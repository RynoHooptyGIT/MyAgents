...
|-------------|-------|------|----------------|--------------|
| Resume stuck story | Dev | Amelia | `/team:dev` | DS (Dev Story) |
| Code review | Dev | Amelia | `/team:dev` | CR (Code Review) |
| Implement ready story | Dev | Amelia | `/team:dev` | DS (Dev Story) |
| Create next story | Oracle | Athena | `/team:oracle` | CS (Create Story) |
| Epic retrospective | Oracle | Athena | `/team:oracle` | RT (Retrospective) |
| Sprint planning | Oracle | Athena | `/team:oracle` | SP (Sprint Plan) |
| Repo health check | Custodian | Sentinel | `/team:custodian` | HC (Health Check) |
| Architecture review | Architect | Winston | `/team:architect` | -- |
| Test strategy | Test Architect | Murat | `/team:tea` | -- |
| Security audit | Security Auditor | Shield | `/team:security-auditor` | -- |
| NIST compliance | NIST Expert | Atlas | `/team:nist-rmf-expert` | -- |
