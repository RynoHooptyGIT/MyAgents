...
Apply the Oracle priority decision tree (same as Next Action workflow, abbreviated):
...
| P4 `[MEDIUM]` | Backlog story needs creation | Oracle (Athena) -> CS |
| P5 `[MEDIUM]` | Epic done, next epic is backlog | Oracle (Athena) -> CS |
| P6 `[LOW]` | Epic done, no retrospective | Oracle (Athena) -> RT |
...
---
Generated by: Project Oracle (Athena) - Project Brief Workflow
```
