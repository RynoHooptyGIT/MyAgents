...
- Execute {project-root}/team/workflows/advanced-elicitation/workflow.xml with the current inspiration analysis content
...
- Execute {project-root}/team/workflows/party-mode/workflow.md with the current inspiration analysis
