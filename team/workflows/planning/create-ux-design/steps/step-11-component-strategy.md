...
- Execute {project-root}/team/workflows/advanced-elicitation/workflow.xml with the current component strategy content
...
- Execute {project-root}/team/workflows/party-mode/workflow.md with the current component strategy
