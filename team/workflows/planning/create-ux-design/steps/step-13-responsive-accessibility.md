...
- Execute {project-root}/team/workflows/advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Execute {project-root}/team/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
