...
- Execute {project-root}/team/workflows/advanced-elicitation/workflow.xml with the current emotional response content
...
- Execute {project-root}/team/workflows/party-mode/workflow.md with the current emotional response definition
