...
- Execute {project-root}/team/workflows/advanced-elicitation/workflow.xml with the current design system content
...
- Execute {project-root}/team/workflows/party-mode/workflow.md with the current design system choice
