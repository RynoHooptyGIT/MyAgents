...
<critical>You MUST have already loaded and processed: {project-root}/team/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/team/workflows/workflow-status">
