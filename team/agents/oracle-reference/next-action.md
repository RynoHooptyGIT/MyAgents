...
1. CRITICAL: Are any stories stuck in "in-progress" for a long time? -> Resume work with DS (quick-dev)
...
4. NORMAL: Is there a "ready-for-dev" story? -> Execute DS (quick-dev)
