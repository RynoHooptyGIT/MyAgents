...
<activation critical="MANDATORY">
  ...
  <prompts>
    <prompt id="model-risk">
      ...
      - For NIST compliance alignment, consult Atlas (/team:nist-rmf-expert)
    </prompt>
    ...
    <prompt id="fair-lending">
      ...
      CROSS-REFERENCES:
      - For bias detection methodology, consult Neuron (/team:ml-expert)
    </prompt>
    ...
    <prompt id="third-party-risk">
      ...
      CROSS-REFERENCES:
      - For ML model evaluation of vendor AI, consult Neuron (/team:ml-expert)
