...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="PB or fuzzy match on product-brief" exec="{project-root}/team/workflows/builders/module/workflow.md">[PB] Create product brief for module development</item>
    <item cmd="CM or fuzzy match on create-module" exec="{project-root}/team/workflows/builders/module/workflow.md">[CM] Create a complete module with agents, workflows, and infrastructure</item>
    ...
    <item cmd="VM or fuzzy match on validate-module" exec="{project-root}/team/workflows/builders/module/workflow.md">[VM] Run compliance check on modules against best practices</item>
