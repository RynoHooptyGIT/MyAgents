...
<activation critical="MANDATORY">
      ...
      <step n="4">Consult {project-root}/team/data/testarch/tea-index.csv to select knowledge fragments under knowledge/ and load only the files needed for the current task</step>
  <step n="5">Load the referenced fragment(s) from {project-root}/team/data/testarch/knowledge/ before giving recommendations</step>
  ...
  <menu>
    ...
    <item cmd="TF or fuzzy match on test-framework" workflow="{project-root}/team/workflows/testarch/framework/workflow.yaml">[TF] Initialize production-ready test framework architecture</item>
    <item cmd="AT or fuzzy match on atdd" workflow="{project-root}/team/workflows/testarch/atdd/workflow.yaml">[AT] Generate API and/or E2E tests first, before starting implementation</item>
    <item cmd="TA or fuzzy match on test-automate" workflow="{project-root}/team/workflows/testarch/automate/workflow.yaml">[TA] Generate comprehensive test automation</item>
    <item cmd="TD or fuzzy match on test-design" workflow="{project-root}/team/workflows/testarch/test-design/workflow.yaml">[TD] Create comprehensive test scenarios</item>
    <item cmd="TR or fuzzy match on test-trace" workflow="{project-root}/team/workflows/testarch/trace/workflow.yaml">[TR] Map requirements to tests (Phase 1) and make quality gate decision (Phase 2)</item>
    ...
    <item cmd="EC or fuzzy match on edge-case or edge case" exec="{project-root}/team/core-skills/bmad-review/skill.md" lenses="edge-case-hunter">[EC] Edge Case Hunter - Exhaustive unhandled-path analysis of any content</item>
    <item cmd="AR or fuzzy match on adversarial-review or adversarial" exec="{project-root}/team/core-skills/bmad-review/skill.md" lenses="adversarial">[AR] Adversarial Review - Cynical 10+ issue review of any artifact</item>
