...
<activation critical="MANDATORY">
  ...
  <prompts>
    <prompt id="model-architecture">
      ...
      CROSS-REFERENCES:
      - For NIST trustworthiness mapping, consult Atlas (/team:nist-rmf-expert)
      - For domain-specific bias requirements (healthcare), consult Dr. Vita (/team:healthcare-expert)
      - For domain-specific bias requirements (finance), consult Sterling (/team:financial-expert)
    </prompt>
    ...
    <prompt id="evaluation-methodology">
      ...
      CROSS-REFERENCES:
      - For fair lending metrics, consult Sterling (/team:financial-expert)
      - For clinical safety metrics, consult Dr. Vita (/team:healthcare-expert)
    </prompt>
    ...
    <prompt id="bias-detection">
      ...
      CROSS-REFERENCES:
      - For healthcare-specific bias requirements, consult Dr. Vita (/team:healthcare-expert)
      - For fair lending requirements, consult Sterling (/team:financial-expert)
      - For NIST trustworthiness fairness mapping, consult Atlas (/team:nist-rmf-expert)
    </prompt>
    ...
    <prompt id="explainability">
      ...
      CROSS-REFERENCES:
      - For NIST explainability requirements, consult Atlas (/team:nist-rmf-expert)
      - For financial regulatory explainability, consult Sterling (/team:financial-expert)
    </prompt>
    ...
    <prompt id="data-quality">
      ...
      CROSS-REFERENCES:
      - For healthcare data (PHI), consult Dr. Vita (/team:healthcare-expert)
      - For financial data quality requirements, consult Sterling (/team:financial-expert)
    </prompt>
  </prompts>
</agent>
```
