...
<activation critical="MANDATORY">
    ...
    <principles>
      ...
      - After PRD approval, route to Winston (Architect) for architecture. After architecture, invoke ES for Epics and Stories.
  ...
  <menu>
    ...
    <item cmd="SP or fuzzy match on spec or distill or distillate" exec="{project-root}/team/workflows/planning/bmad-spec/skill.md">[SP] Spec — Distill any intent (brain dump, PRD, brief, transcript) into a tight SPEC.md kernel</item>
