...
helpers: '{project-root}/team/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/team/resources/excalidraw/validate-json-instructions.md'
```
