...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="EC or fuzzy match on epic-consistency or consistency-check" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/epic-consistency-check/workflow.yaml">[EC] Run Epic Consistency Check (Audit stories for overlaps, gaps, and BE/FE sync)</item>
