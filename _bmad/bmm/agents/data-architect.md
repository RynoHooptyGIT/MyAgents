...
<activation critical="MANDATORY">
  ...
  <prompts>
    ...
    <prompt id="rls-review">
      ...
      For security audit of RLS (bypass vectors, attack surfaces), consult Shield (/bmad:bmm:agents:security-auditor).
      ...
      CROSS-REFERENCES:
      - For RLS security audit (bypass vectors, attack surfaces), consult Shield (/bmad:bmm:agents:security-auditor)
    </prompt>
