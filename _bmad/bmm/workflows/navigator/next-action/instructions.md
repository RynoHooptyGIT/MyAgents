...
| Create next story | Scrum Master | Bob | `/bmad:bmm:agents:sm` | CS (Create Story) |
| Epic retrospective | Scrum Master | Bob | `/bmad:bmm:agents:sm` | ER (Epic Retro) |
| Sprint planning | Scrum Master | Bob | `/bmad:bmm:agents:sm` | SP (Sprint Plan) |
...
`[CRITICAL]` Never recommend an action that Navigator itself should perform. Navigator is read-only and routes to specialists.
...
---
Generated by: Project Navigator (Navi) - Next Action Workflow
```
