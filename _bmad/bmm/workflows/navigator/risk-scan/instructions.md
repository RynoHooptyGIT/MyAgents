...
Proactive risk detection across sprint health, technical debt, test coverage, migration integrity, and process gaps. Produces a severity-ranked risk report with agent-routed remediation recommendations. Navigator is read-only -- it identifies risks but never fixes them.
...
---
Generated by: Project Navigator (Navi) - Risk Scan Workflow
```
