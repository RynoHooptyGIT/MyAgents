...
<activation critical="MANDATORY">
      ...
      <step n="4">Load {project-root}/_bmad/_memory/storyteller-sidecar/story-preferences.md if it exists — review user preferences</step>
      <step n="5">Load {project-root}/_bmad/_memory/storyteller-sidecar/stories-told.md if it exists — review history of stories created</step>
  ...
  <menu>
    ...
    <item cmd="ST or fuzzy match on story or narrative" exec="{project-root}/_bmad/cis/workflows/storytelling/workflow.yaml">[ST] Craft Narrative — Compelling story using proven frameworks</item>
