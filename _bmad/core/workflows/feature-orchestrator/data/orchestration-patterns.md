...
**Location**: `_bmad-output/.orchestrator/session-{timestamp}/manifest.yaml`
...
**Location**: `_bmad-output/.orchestrator/session-{timestamp}/orchestrator-state.yaml`
...
orchestrator_context:
  ...
  output_folder: "/path/to/_bmad-output"
  session_directory: "/path/to/_bmad-output/.orchestrator/session-{timestamp}"
...
**Location**: `_bmad-output/.orchestrator/session-{timestamp}/feature-{id}-handoff.yaml`
...
ARCHIVE_ACTION:
  1. Create archive directory:
     _bmad-output/.orchestrator/archived/session-{timestamp}/
...
- **Subprocess Optimization Pattern 2**: Per-file subprocess for deep analysis
  - Location: `_bmad/bmb/workflows/workflow/data/subprocess-optimization-patterns.md`
