...
WORKFLOW_START:
  ...
  1. Check for Incomplete Sessions:
     SEARCH: _bmad-output/.orchestrator/session-*/
  ...
  2. Create New Session:
     ...
     session_dir = "_bmad-output/.orchestrator/session-{timestamp}"
  ...
  3. Load Configuration:
     READ: _bmad/core/config.yaml (if exists)
     EXTRACT:
       - user_name
       - output_folder
...
**Outputs**:
- Archived session in `_bmad-output/.orchestrator/archived/`
...
**Location**: `_bmad/core/workflows/feature-orchestrator/config.yaml`
...
output:
  session_directory: "_bmad-output/.orchestrator"
  archive_directory: "_bmad-output/.orchestrator/archived"
...
```
_bmad/core/workflows/feature-orchestrator/
...
**Active Session** (`_bmad-output/.orchestrator/session-{timestamp}/`):
...
**Archived Session** (`_bmad-output/.orchestrator/archived/session-{timestamp}/`):
